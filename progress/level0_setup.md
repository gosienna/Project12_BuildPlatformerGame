...
Progress: **bite 4 of 10** — waiting for learner to create `check_setup.py`

## Bites

- [x] **1.** Confirm Python 3.10+ (`python3 --version`)
...
- [ ] **4.** Create `check_setup.py` yourself, run it, see the green "Setup OK!" window
...
- [ ] **9.** In one sentence, explain why we use a `.venv` instead of installing arcade for the whole computer
- [ ] **10.** Confirm you can run a `.py` file from your editor or the terminal
